 ...
 */
public class LoginActivity extends K9Activity implements OnClickListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.account_setup_login);
...
//        mProgressBar.setIndeterminate(true);
    ...
    private void login() {
        new CheckAccountTask(mAccount, new CallBack() {
            @Override
            public void succeed() {
                if (mDirection == CheckDirection.OUTGOING) {
                    mAccount.setDescription(mAccount.getEmail());
                    mAccount.save(Preferences.getPreferences(LoginActivity.this));
                    K9.setServicesEnabled(LoginActivity.this);
                ...
                new CheckAccountTask(mAccount, new CallBack() {
                    ...
                    @Override
                    public void failed(int code, String des) {
    ...
    public interface CallBack {
        ...
        void failed(int code, String des);
    }
...
//                login();
     ...
     */
    private class CheckAccountTask extends AsyncTask<CheckDirection, Integer, Integer> {
        private final CallBack callBack;
        private Account account;


        public CheckAccountTask(final Account account, CallBack callBack) {
            this.account = account;
            this.callBack = callBack;
        }

        @Override
        protected Integer doInBackground(CheckDirection... params) {
            int code = 0;
